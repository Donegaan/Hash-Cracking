...
# dictionary attack
echo "Rockyou"
hashcat -m 500 -a 0 -O -w 4 --potfile-path=mypot.potfile ./hashes/pbk.txt ./wordlists/rockyou.txt

# mask attack for 5 lowercase letters
echo "Mask"
hashcat -m 500 -a 3 -O -w 4 --potfile-path=mypot.potfile ./hashes/pbk.txt ?l?l?l?l?l
